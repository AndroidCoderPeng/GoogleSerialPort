...
#include <jni.h>
/* Header for class com_casic_pengxh_ndk_uart_SerialPort */

#ifndef _Included_com_casic_pengxh_ndk_uart_SerialPort
#define _Included_com_casic_pengxh_ndk_uart_SerialPort
#ifdef __cplusplus
extern "C" {
#endif
/*
